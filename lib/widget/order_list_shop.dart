...
class _OrderListShopState extends State<OrderListShop> {
  ...
  Future<Null> findIdShopAndReadOrder() async {
    ...
    String path =
        '${MyConstant().domain}/TakFood/getOrderWhereIdShop.php?isAdd=true&idShop=$idShop';
    ...
    return Scaffold(
      body: orderModels.length == 0
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) => Card(color: index%2 ==0 ?Colors.lime.shade100 :Colors.lime.shade400,
                              child: Padding(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        RaisedButton.icon(color: Colors.red,
                        ...
                        RaisedButton.icon(color: Colors.green,
                            shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(30)),
                            onPressed: () {},
  ...
  Container buildTitle() {
    return Container(
      ...
      decoration: BoxDecoration(color: Colors.lime.shade600),
      child: Row(
        children: [
          Expanded(
            flex: 3,
